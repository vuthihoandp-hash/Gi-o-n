...
<div class="main-header">
    ...
    <p>Tác giả: Vũ Thị Hoãn - Trường Tiểu học Đông An - ĐT: 0912548351</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Vũ Thị Hoãn - Trường Tiểu học Đông An - ĐT: 0912548351</div>", unsafe_allow_html=True)
